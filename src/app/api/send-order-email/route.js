...
//                 <div style="font-size: 15px; font-weight: 700; color: #0f172a; margin-bottom: 4px;">${productName}</div>
//                 ${productUrl !== '#' ? `<div style="margin-bottom: 8px;"><a href="${productUrl}" target="_blank" style="color: #6366f1; font-size: 12px; text-decoration: underline; word-break: break-all;">${productUrl}</a></div>` : ''}
//                 ${singleProduct.selectedColor ? `<div style="font-size: 12px; color: #64748B; margin-bottom: 4px;">Color: ${singleProduct.selectedColor}</div>` : ''}
//                 <div style="font-size: 12px; font-family: monospace; color: #64748B; margin-top: 4px;">Product ID: ${productId}</div>
//               </div>
